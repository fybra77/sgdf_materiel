...
.tableau {width:100%;table-layout: auto;width:100%;border: 5px solid #000;}
...
<script>
  ...
  function twTriTableau() {
    ...
    // Construit les ligne du nouveau tableau
    for(i = 0; i < nNbrLigne; i++){
		if(aColonne[i][7]=='Oui')
			aColonne[i] = "<td BGCOLOR='#8AE999'>"+aColonne[i].join("</td><td BGCOLOR='#8AE999'>")+"</td>";
		else
			aColonne[i] = "<td BGCOLOR='#FF6833'>"+aColonne[i].join("</td><td BGCOLOR='#FF6833'>")+"</td>";
    }
